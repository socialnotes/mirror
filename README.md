...
As can be seen [here](https://github.com/gigaroby/mirror/blob/8d62da77c534f32d9e2889ed7bcda315ee667e9f/views/upload.go#L51)
...
- Report or Fix issues [here](https://github.com/gigaroby/mirror/issues)
- Propose or Implement features [here](https://github.com/gigaroby/mirror/issues)

## REQUIREMENTS:
- go 1.5+

## INSTALL:
- Install the software as `go get github.com/gigaroby/mirror`
- Install the indexer as `go get github.com/gigaroby/mirror/indexer`
